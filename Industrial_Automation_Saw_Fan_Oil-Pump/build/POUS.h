...
typedef struct {
  ...
  __DECLARE_VAR(BOOL,SAW)
  __DECLARE_VAR(BOOL,FAN)
  __DECLARE_VAR(BOOL,OIL_PUMP)
  __DECLARE_VAR(BOOL,START_BUTTON)
  __DECLARE_VAR(BOOL,SAW_OFF)
  __DECLARE_VAR(BOOL,FAN_RESET_BUTTON)
  __DECLARE_VAR(BOOL,SAW_RUN_20S_RESET)

  // PROGRAM private variables - TEMP, private and located variables
  SR SR0;
  __DECLARE_VAR(BOOL,SAW_RUN_20S)
  SR SR1;
  SR SR2;
  R_TRIG R_TRIG0;
  TON TON0;
  ...
  __DECLARE_VAR(BOOL,_TMP_NOT20_OUT)
  __DECLARE_VAR(BOOL,_TMP_AND6_OUT)
  __DECLARE_VAR(BOOL,_TMP_AND23_OUT)
  __DECLARE_VAR(BOOL,_TMP_OR7_OUT)
  __DECLARE_VAR(BOOL,_TMP_AND22_OUT)
  __DECLARE_VAR(BOOL,_TMP_OR5_OUT)

} INDUSTRIAL_AUTOMATION_PRACTICE_SAW_FAN_OIL_PUMP;
